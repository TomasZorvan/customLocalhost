...
function wp_dashboard_primary() {
	$feeds = array(
		'local'   => array(
			'link'         => apply_filters( 'dashboard_local_link', __( 'http://wp.sk/' ) ),
			'url'          => apply_filters( 'dashboard_local_feed', __( 'http://wp.sk/feed/' ) ),
			'title'        => apply_filters( 'dashboard_local_title', __( 'WordPress Slovensko' ) ),
			'items'        => 2,
			'show_summary' => 1,
			'show_author'  => 0,
			'show_date'    => 1,
