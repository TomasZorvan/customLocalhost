...
<div id="news-section">
	...
	<?php if ( 'on' == $display_news_section ) { ?>
		...
		<?php if ( ( $more_news_link = et_get_option( 'harmony_more_news_link' ) ) && '' != $more_news_link ) { ?>
			<a href="<?php echo esc_url( $more_news_link ); ?>" class="more"><?php esc_html_e( 'Viac', 'Harmony' ); ?></a>
		<?php } ?>
		</div> <!-- end #news -->
...
?>
		...
		?>
			...
			<a href="<?php echo esc_url( get_post_type_archive_link( 'event' ) ); ?>" class="more"><?php esc_html_e( 'Viac', 'Harmony' ); ?></a>
		</div> <!-- end #shows -->
	<?php endif; ?>
...
<div id="media-gallery" class="main_bg">
	...
	<?php
		...
		?>
			...
			<?php if ( '' != $gallery_date ) { ?>
				<div class="image-date"><span><?php echo date_i18n( et_get_option( 'harmony_date_format', 'M j, Y' ), $gallery_date ); ?></span></div>
			<?php } ?>
			</div> <!-- .gallery-photo -->
		<?php endwhile; ?>
		</div> <!-- end #gallery-photos -->
		<a href="<?php echo esc_url( get_post_type_archive_link( 'gallery' ) ); ?>" class="view-more"><?php esc_html_e( 'Viac', 'Harmony' ); ?></a>
	</div> <!-- end .container -->
